...
const (
	...
	// Test runs. Submitted by the e2e suite's API key after each Playwright run;
	// read by whoever reviews results. There is no update/delete: a run is a
	// historical record of what actually happened, not something to edit.
	PermTestRunsCreate Permission = "testruns.create"
	PermTestRunsRead   Permission = "testruns.read"
)
...
var Catalog = []CatalogEntry{
	...
	{PermTestRunsCreate, "Submit e2e test run results"},
	{PermTestRunsRead, "View e2e test run results"},
}
