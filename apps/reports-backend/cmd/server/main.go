...
import (
	...
	"github.com/miguelrosalesmtl/geronimo/apps/reports-backend/internal/logger"
	"github.com/miguelrosalesmtl/geronimo/apps/reports-backend/internal/mail"
	"github.com/miguelrosalesmtl/geronimo/apps/reports-backend/internal/server"
...
func run() error {
	...
	testrunsService := testruns.NewService(pool, log)
	...
	srv := server.New(cfg.Server, cfg.RateLimit, cfg.CORS, cfg.App.Debug, identityService, testrunsService, pool, log)
